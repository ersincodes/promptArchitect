...
export const DecorativeBlurs: React.FC<DecorativeBlursProps> = ({
  ...
  if (variant === "overlay") {
    return (
      <>
        ...
        <div className="pointer-events-none absolute bottom-20 right-10 h-56 w-56 rounded-full bg-gradient-to-r from-violet-500/20 to-indigo-400/20 blur-[100px]" />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <div className="pointer-events-none absolute -bottom-10 right-4 h-40 w-40 rounded-full bg-gradient-to-r from-blue-500/30 to-sky-400/30 blur-[120px]" />
    </>
  );
};
